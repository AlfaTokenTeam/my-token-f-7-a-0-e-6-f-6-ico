...
import "./MyTokenF7A0E6F6.sol";

contract MyTokenF7A0E6F6PreSale {
    MyTokenF7A0E6F6 public token;
    ...
    function MyTokenF7A0E6F6PreSale(
        MyTokenF7A0E6F6 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenF7A0E6F6(_token);
